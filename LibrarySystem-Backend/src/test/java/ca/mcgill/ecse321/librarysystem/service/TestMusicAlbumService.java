...
public class TestMusicAlbumService {
  ...
  public void testGetAllMusicAlbums() {
    ArrayList<Item> musicAlbums = null;

    try {
      musicAlbums = new ArrayList<Item>(musicAlbumService.getAllMusicAlbums());;
    } catch (IllegalArgumentException e) {
      fail();
    }
    assertNotNull(musicAlbums);
    assertEquals(2, musicAlbums.size());
    assertEquals(correctString, musicAlbums.get(0).getItemTitle());
    assertEquals(correctString, musicAlbums.get(0).getDescription());
    assertEquals(correctString, musicAlbums.get(0).getImageUrl());
    assertEquals(correctString, musicAlbums.get(0).getGenre());
    assertEquals(correctDate, musicAlbums.get(0).getPublishDate());
    assertEquals(true, musicAlbums.get(0).getIsReservable());
    assertEquals(correctString, ((MusicAlbum) musicAlbums.get(0)).getArtist());
    assertEquals(correctString, ((MusicAlbum) musicAlbums.get(0)).getRecordingLabel());
    
    assertEquals(correctString, musicAlbums.get(1).getItemTitle());
    assertEquals(correctString, musicAlbums.get(1).getDescription());
    assertEquals(correctString, musicAlbums.get(1).getImageUrl());
    assertEquals(correctString, musicAlbums.get(1).getGenre());
    assertEquals(correctDate, musicAlbums.get(1).getPublishDate());
    assertEquals(true, musicAlbums.get(1).getIsReservable());
    assertEquals(correctString, ((MusicAlbum) musicAlbums.get(1)).getArtist());
    assertEquals(correctString, ((MusicAlbum) musicAlbums.get(1)).getRecordingLabel());

    for (Item musicAlbum : musicAlbums) {
      System.out.println(musicAlbum.getItemTitle());
    }
  }
}
