...
public class ShiftController {
  ...
  public ResponseEntity<?> modifyShift(
    @RequestParam String currentUserId,
   ...
   */
  @DeleteMapping(
    value = { "/remove_librarian_shifts", "/remove_librarian_shifts/" }
  )
  public ResponseEntity<?> removeLibrarianShifts(
    @RequestParam String currentUserId,
    @RequestParam String librarianId
  ) {
    boolean isDeleted = false;
    try {
      isDeleted =
        shiftService.removeLibrarianShifts(currentUserId, librarianId);
    } catch (IllegalArgumentException e) {
      return new ResponseEntity<>(e.getMessage(), HttpStatus.BAD_REQUEST);
    }
    return new ResponseEntity<>(isDeleted, HttpStatus.CREATED);
  ...
  public ResponseEntity<?> viewShift(
    @RequestParam String currentUserId,
    @RequestParam String timeSlotId
  ) {
    Shift shift = null;
  ...
  public ResponseEntity<?> viewLibrarianShifts(
    @RequestParam String currentUserId,
    @RequestParam String librarianId
  ) {
    ...
    try {
      shifts =
        shiftService
          .getAllShiftsForLibrarian(currentUserId, librarianId)
          .stream()
