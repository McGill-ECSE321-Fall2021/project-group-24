...
public class RoomController {
  ...
  @GetMapping(
    value = { "/view_rooms/{roomNumber}", "/view_rooms/{roomNumber}/" }
  )
  public ResponseEntity<?> getRoom(
    ...
    try {
      return new ResponseEntity<Object>(
        convertToDto(roomService.getRoom(roomNumber)),
        HttpStatus.OK
      );
    } catch (IllegalArgumentException e) {
      return new ResponseEntity<Object>(e.getMessage(), HttpStatus.BAD_REQUEST);
   ...
   */
  @PostMapping(
    value = { "/create_room/{roomNumber}", "/create_room/{roomNumber}/" }
  )
   ...
   */
  @DeleteMapping(
    value = { "/delete_room/{roomNum}", "/delete_room/{roomNum}/" }
  )
